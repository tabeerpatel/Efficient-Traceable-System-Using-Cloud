...
//            }
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="content_resize" style="background-image: url(images/membg.jpg)">
                    <div class="templatemo_content_section_01">
                        <div class="section_01_left" style="margin-left: 20px;height: 325px">
                            <p style="font-family: cursive; font-size:30px;margin-left: 290px">Welcome <%=getu%></p>
                        </div>                      
                    </div>
                    <div class="sidebar">
                    </div>
