...
<!--                            <li class="active"><a href="PublicAudting.jsp"><strong>Public_Auditing</strong></a></li>-->
            ...
            <div class="content">
                <div class="content_resize" style="background-image: url(images/bg1.jpg)">
                    <div align="center">
                        <fieldset style="border-radius: 9px;width: 500px;height: 200px;border-color: white">
                            <br></br><center>
                                <p style="font-family: cursive; font-size:30px; color: white">Wrong File Credentials</p>
                            </center>
                        </fieldset>
                                        </div>
                                        <div class="sidebar">
