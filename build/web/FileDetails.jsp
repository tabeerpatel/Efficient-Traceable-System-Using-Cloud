    ...
    <body>
        <div class="main">
                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li class="active"><a href="FileDetails.jsp"><strong>File Details</strong></a></li>
            ...
            <div class="content_resize" style="background-image: url(images/bg1.jpg)">
                <p style="font-size: 20px;position: relative;left: 120px;color: white">File Access from Cloud</p>
                <table align="center" style="font-family: fantasy; ">
                    ...
                    <tr align="center" style="font-family:verdana;font-size:12px;"> 
                        ...
                        <td> <font style="color: white"><a href="Del_Verify.jsp?<%=mail%>" style="color: white">Delete</a></font> </td>
                        <td> <font style="color: white"><a href="view.jsp?<%=host%>" style="color: white">View</a></font> </td>
                    </tr>
                    <%
                            }
                        } catch (Exception e) {
